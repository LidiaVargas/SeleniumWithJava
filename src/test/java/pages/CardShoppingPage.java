...
public class CardShoppingPage {
    ...
    public static void clickOnProduct (String productName) {
        WebElement product = Commons.findElementVisibleByXpath(PRODUCT_BUTTON.formatted(productName));
        Commons.click(product);
    }

    public static String buttonTextColor (String productName){
        WebElement buttonTextColorChange = Commons.findElementVisibleByXpath(PRODUCT_BUTTON.formatted(productName));
        return Commons.getCssAttribute(buttonTextColorChange, "color");
    }

    public static String buttonText (String productName){
        WebElement buttonTextChange = Commons.findElementVisibleByXpath(PRODUCT_BUTTON.formatted(productName));
        return Commons.getText(buttonTextChange);
    }

    public static String shoppingCartText (){
        WebElement shoppingCartNumb = Commons.findElementVisibleByXpath(SHOPING_CART_NUMBER);
